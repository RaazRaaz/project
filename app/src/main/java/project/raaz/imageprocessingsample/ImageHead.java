...
public class ImageHead extends ImageHeadScale{

    private String owner_id;
    private ImageView iv_main;
    public ImageHead(Context context) {
        super(context);
    }

    public ImageHead(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ImageHead(Context context, AttributeSet attrs, int defStyle) {
